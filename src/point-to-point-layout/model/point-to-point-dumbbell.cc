...
NetDeviceContainer PointToPointDumbbellHelper::GetRouterDevice() const
{
...
void PointToPointDumbbellHelper::InstallControl(TrafficControlHelper tch){
    tch.Install(m_leftLeafDevices);
    tch.Install(m_rightLeafDevices);
    tch.Install(m_routerDevices);
}
